...
<head>
    ...
    <!--external css-->
    <link href="http://thevectorlab.net/flatlab-4/assets/font-awesome/css/font-awesome.css" rel="stylesheet" />
    <link href="http://thevectorlab.net/flatlab-4/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen"/>
    <link rel="stylesheet" href="http://thevectorlab.net/flatlab-4/css/owl.carousel.css" type="text/css">

    <!--right slidebar-->
    <link href="http://thevectorlab.net/flatlab-4/css/slidebars.css" rel="stylesheet">

    <!-- Custom styles for this template -->

    <link href="http://thevectorlab.net/flatlab-4/css/style.css" rel="stylesheet">
    <link href="http://thevectorlab.net/flatlab-4/css/style-responsive.css" rel="stylesheet" />
